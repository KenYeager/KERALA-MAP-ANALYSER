...
import { MapPin, Zap, Car, Maximize2, Trash2, Download, Grid3x3 } from 'lucide-react';
    ...
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">
          Draw polygons to analyze EV infrastructure and demographics using real Kerala data
        </p>
      </div>
      <div className="flex gap-3">
        ...
        <button
          ...
          className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors font-medium ${
            showCharging ? 'bg-green-600 text-white hover:bg-green-700' : 'bg-white text-gray-700 hover:bg-gray-100'
          }`}
        >
          <Zap size={16} />
        ...
        <button
          ...
          className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors font-medium ${
            showPetrol ? 'bg-red-600 text-white hover:bg-red-700' : 'bg-white text-gray-700 hover:bg-gray-100'
          }`}
        >
          <Car size={16} />
        ...
        {hasPolygon && (
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors font-medium ${
              showGrid ? 'bg-purple-600 text-white hover:bg-purple-700' : 'bg-white text-gray-700 hover:bg-gray-100'
            }`}
          >
            <Grid3x3 size={16} />
